...
Shader "Toony Colors Pro 2/User/MyOutlineShader"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
...
/* TCP_DATA u config(ver:"2.9.1";unity:"2021.3.6f1";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","TEMPLATE_LWRP","SHADOW_LINE","SKETCH_GRADIENT","SKETCH_SHADER_FEATURE","OUTLINE_URP_FEATURE","OUTLINE","OUTLINE_ZSMOOTH","OUTLINE_CLIP_SPACE","OUTLINE_CONSTANT_SIZE","OUTLINE_PIXEL_PERFECT","DISSOLVE_CLIP","DISSOLVE_GRADIENT","DISSOLVE_SHADER_FEATURE","WIND_SHADER_FEATURE"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0"];shaderProperties:list[];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH 534e36da865d06b7a93fe4d6322ca78c */
